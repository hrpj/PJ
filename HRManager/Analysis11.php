...
<html lang="en">
  ...
  <body>
      <div class = "Analysis"><h3>The manager who has the most salary in company</h></div>
          <table class="table">
...
<?php
	$result = mysqli_query($con,"SELECT staffID, salary FROM increasesalaryrecord ORDER BY salary DESC LIMIT 1");
