...
<html lang="en">
  ...
  <body>
      <div class = "Analysis"><h3>Amount of gender in this company</h></div>
          <table class="table">
...
<?php
	$result = mysqli_query($con,"SELECT gender, COUNT(staffID) AS Count FROM staff GROUP BY gender");
