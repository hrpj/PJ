                ...
                <tbody>
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($result))
                        {
                            ...
                            $endDate = $row['endDate'];
                            echo "<tr>";
                            echo "<form id='companyDelete' action='http://localhost/HRPJ/HRManager/StaffInforWorkAction.php' method='post' >";
                ...
                <tbody>
                    <?php
                        ...
                        while ($row = mysqli_fetch_array($result))
                        {
                            ...
                            $degree = $row['degree'];
                            echo "<tr>";
                            echo "<form id='educationDelete' action='http://localhost/HRPJ/HRManager/StaffInforEducationAction.php' method='post' >";
                            echo "<th scope='row'>".$j."</th>";
                            echo "<td><input type='text' name='university".$j."' value='".$university."'></td>";
                            echo "<td><input type='text' name='field".$j."' value='".$field."''></td>";
                            echo "<td><input type='text' name='degree".$j."' value='".$degree."''></td>";
                            echo "<input type='hidden' name='i' value='".$i."'>";
