...
session_start();
	...
	{
		header("Location: http://localhost/HRPJ/HRManager/P03-2ERROR-PaymentSearch.php");
	}
	else
	{
		$_SESSION["YEAR"] = $year;
		$_SESSION["MONTH"] = $month;
		header("Location: http://localhost/HRPJ/HRManager/P03-3-PaymentStaffSuccessForHR.php");
	}
	mysqli_close($con);
?>
