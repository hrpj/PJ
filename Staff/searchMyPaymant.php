...
session_start();
	...
	{
		header("Location: http://localhost/HRPJ/Staff/P01-1E-PaymentSearchForStaff.php");
	}
	else
	{
		$_SESSION["YEAR"] = $year;
		$_SESSION["MONTH"] = $month;
		header("Location:  http://localhost/HRPJ/Staff/P01-2-PaymentStaffSuccessForStaff.php");
	}
	mysqli_close($con);
?>
